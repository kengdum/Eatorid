...
const generateRestaurants = () => __awaiter(void 0, void 0, void 0, function* () {
    ...
    return yield Restaurant_1.default.insertMany(data);
});
const generateMenu = (restaurant) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    yield Menu_1.default.insertMany(data);
});
